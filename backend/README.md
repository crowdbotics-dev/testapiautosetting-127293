...
## Project Structure
    ...
    ├── testapiautosetting_127293  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127293`
...
2. Clone this repo and `cd testapiautosetting_127293`
